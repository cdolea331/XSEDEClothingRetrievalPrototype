...
from cpn_landmark_detection.net import seresnet_cpn as cpn
from cpn_landmark_detection.utility import train_helper
from cpn_landmark_detection.utility import mertric
...
tf.app.flags.DEFINE_string(
    'data_dir', config.RECORDS_DATA_DIR,#'/media/rs/0E06CD1706CD0127/Kapok/Chi/Datasets/tfrecords',
